...
<#macro formInput path attributes="" fieldType="text">
    ...
    <input type="${fieldType}" id="${status.expression}" name="${status.expression}" value="<#if fieldType!="password">${stringStatusValue?html}</#if>" ${attributes}<@closeTag/>
</#macro>
...
<#macro formSingleSelect path options attributes="" >
    <@bind path/>
    <select class="customSelect" id="${status.expression}" name="${status.expression}" ${attributes}>
        <#if options?is_hash>
